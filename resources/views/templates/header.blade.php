<div class="app-header header top-header">
    <div class="container">
        <div class="d-flex">
            <a class="header-brand text-left" href="/admin/home">
                <img src="{{ asset('images/logo-makaryo-2.png')}}" class="header-brand-img desktop-lgo" alt="Dashtic logo">
                <img src="{{ asset('images/logo-makaryo-2.png')}}" class="header-brand-img dark-logo" alt="Dashtic logo">
                <img src="{{ asset('images/simple-MAKARYO.png')}}" class="header-brand-img mobile-logo" alt="Dashtic logo">
                <img src="{{ asset('images/simple-MAKARYO.png')}}" class="header-brand-img darkmobile-logo" alt="Dashtic logo">
            </a>
            ...
            <div class="d-flex order-lg-2 ml-auto">
                ...
                <div class="dropdown profile-dropdown">
                    <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                        <span>
                            <img src="{{ asset('images/logopolkesyoo.webp')}}" alt="img" class="avatar avatar-md brround" style="border: solid 1px #505ac3;">
                        </span>
                    </a>
