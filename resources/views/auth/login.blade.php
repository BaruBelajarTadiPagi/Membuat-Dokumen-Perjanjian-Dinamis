...
<html lang="en" dir="ltr">
	<head>
		...
		<meta name="description" content="Belajar Online Tanpa Batas" />
		...
		<meta property="og:title" content="poltekkes Yogyakarta" />
		<meta property="og:description" content="Belajar Online Tanpa Batas" />
		<meta property="og:image" content="{{ asset('images/logopolkesyoo.webp')}}" />
		<meta property="og:site_name" content="Kartunikah" />
		<meta property="og:locale" content="id_ID" />
		<meta property="og:type" content="website" />
		<meta name="twitter:card" content="summary" />
		<meta name="twitter:site" content="@seven_pion" />
		<meta name="twitter:title" content="poltekkes Yogyakarta" />
		<meta name="twitter:description" content="Belajar Online Tanpa Batas" />
		<meta name="twitter:image" content="{{ asset('images/logo-poltekkes Yogyakarta.png')}}" />
		<meta itemprop="description" content="Belajar Online Tanpa Batas">
		<meta content="NPCI Jawa Tengah" name="author">

		<!-- Title -->
		<title>poltekkes Yogyakarta</title>

		<!--Favicon -->
		<link rel="icon" href="{{ asset('images/logopolkesyoo.webp')}}" type="image/x-icon"/>
										...
										<div class="card p-4">
											<div class="card-body">
												<div class="text-center title-style mb-6">
													<img src="{{ asset('images/logopolkesyoo.webp')}}" alt="" style="width: 30%">
													{{-- <h1 class="mb-2">
														Login
													</h1> --}}
													<hr>
													<br>
													<p class="text-muted mt-4">Sign In to Poltekkes Yogyakarta Certificates</p>
												</div>
                                                <form method="POST" action="{{ route('login') }}">
													...
													<div class="row">
														<div class="col-12">
															<button type="submit" class="btn btn-lg btn-primary btn-block"><i class="fe fe-arrow-right"></i>{{ __('Login') }}</button>
														</div>
													</div>
                                                </form>
											</div>
