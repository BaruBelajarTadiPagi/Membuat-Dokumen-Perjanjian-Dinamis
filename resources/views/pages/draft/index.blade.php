            ...
            <div class="page-header">
                ...
                <div class="page-rightheader ml-auto d-lg-flex d-none">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.draft.index') }}">List Draft Kesepahaman</a></li>
                    </ol>
                </div>
            </div>
            <!--End Page header-->
            ...
            <div class="row">
                                ...
                                <table class="table table-bordered table-striped text-nowrap mb-0" id="example1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a download="" href="{{ route('admin.draft.download', ['id' => $draft->id]) }}">
                                                    <button class="btn btn-sm btn-primary">Download Dokumen</button>
                                                </a>
                                                <a href="{{ route('admin.draft.edit', ['id' => $draft->id]) }}">
                                                ...
                                                <!-- Modal -->
                                                <form action="{{ route('admin.draft.destroy', ['id' => $draft->id]) }}"
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ @$edit_mode ? route('admin.draft.update', ['id' => $detail->id]) : route('admin.draft.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @if (@$edit_mode)
                                @method('PUT')
                                @endif
                                <div class="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" class="form-control @error('name') is-invalid @enderror" id="address" placeholder="Alamat Rumah Sakit" cols="30" rows="10">{{ @$edit_mode ? $detail->address : old('address') }}</textarea>
                                        @error('address')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="position" class="form-control @error('position') is-invalid @enderror" id="position" placeholder="Direktur/Sekretaris" value="{{ @$edit_mode ? $detail->position : old('position') }}">
                                        @error('position')
