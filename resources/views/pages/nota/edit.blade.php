        ...
        <div class="container">
            ...
            <div class="page-header">
                <div class="page-leftheader">
                    <h4 class="page-title">Edit Cabang Olahraga</h4>
                </div>
                <div class="page-rightheader ml-auto d-lg-flex d-none">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#" class="d-flex"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 3L2 12h3v8h6v-6h2v6h6v-8h3L12 3zm5 15h-2v-6H9v6H7v-7.81l5-4.5 5 4.5V18z"/><path d="M7 10.19V18h2v-6h6v6h2v-7.81l-5-4.5z" opacity=".3"/></svg><span class="breadcrumb-icon"> Home</span></a></li>
                        <li class="breadcrumb-item"><a href="/cabors">List Cabang Olahraga</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-lg-8">
                    ...
                    <div class="card">
                        <div class="card-header">
                            {{-- <h3 class="card-title">List Cabang Olahraga</h3> --}}
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered table-striped text-nowrap mb-0" id="example1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('cabors.destroy',$cabors->id) }}" method="POST">
                                    
                                                    <a class="btn btn-sm btn-success" href="{{ route('cabors.edit',$cabors->id) }}">Edit</a>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit Cabang Olahraga</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('cabors.update',['id'=> $edit->id]) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mb-4" name="description" id="description" rows="3">{{$edit->description}}</textarea>
                                    </div>
