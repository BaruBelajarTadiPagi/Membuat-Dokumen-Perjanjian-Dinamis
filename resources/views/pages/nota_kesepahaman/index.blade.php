        ...
        <div class="container">
            ...
            <div class="page-header">
                <div class="page-leftheader">
                    <h4 class="page-title">List Nota Kesepahaman Akademi</h4>
                </div>
                <div class="page-rightheader ml-auto d-lg-flex d-none">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#" class="d-flex"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 3L2 12h3v8h6v-6h2v6h6v-8h3L12 3zm5 15h-2v-6H9v6H7v-7.81l5-4.5 5 4.5V18z"/><path d="M7 10.19V18h2v-6h6v6h2v-7.81l-5-4.5z" opacity=".3"/></svg><span class="breadcrumb-icon"> Home</span></a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.nota_kesepahaman.index') }}">List Nota Kesepahaman Akademi</a></li>
                    </ol>
                </div>
            </div>
            <!--End Page header-->
            ...
            <div class="row">
                                ...
                                <table class="table table-bordered table-striped text-nowrap mb-0" id="example1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a href="{{ route('admin.nota_kesepahaman.download', ['id' => $draft->id]) }}">
                                                    <button class="btn btn-sm btn-primary">Download Dokumen</button>
                                                </a>
                                                <a href="{{ route('admin.nota_kesepahaman.edit', ['id' => $draft->id]) }}">
                                                ...
                                                <!-- Modal -->
                                                <form action="{{ route('admin.nota_kesepahaman.destroy', ['id' => $draft->id]) }}"
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ @$edit_mode ? route('admin.nota_kesepahaman.update', ['id' => $detail->id]) : route('admin.nota_kesepahaman.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @if (@$edit_mode)
                                @method('PUT')
                                @endif
                                <div class="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nip" class="form-control @error('nip') is-invalid @enderror" id="nip" placeholder="221311211311" value="{{ @$edit_mode ? $detail->nip : old('nip') }}">
                                        @error('nip')
