        ...
        <div class="container">
            ...
            <div class="page-header">
                <div class="page-leftheader">
                    <h4 class="page-title">List Naskah Perjanjian Kerjasama</h4>
                </div>
                <div class="page-rightheader ml-auto d-lg-flex d-none">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#" class="d-flex"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 3L2 12h3v8h6v-6h2v6h6v-8h3L12 3zm5 15h-2v-6H9v6H7v-7.81l5-4.5 5 4.5V18z"/><path d="M7 10.19V18h2v-6h6v6h2v-7.81l-5-4.5z" opacity=".3"/></svg><span class="breadcrumb-icon"> Home</span></a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.npk_instansi.index') }}">List Naskah Perjanjian Kerjasama</a></li>
                    </ol>
                </div>
            </div>
            <!--End Page header-->
            ...
            <div class="row">
                                ...
                                <table class="table table-bordered table-striped text-nowrap mb-0" id="example1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a href="{{ route('admin.npk_instansi.download', ['id' => $draft->id]) }}">
                                                    <button class="btn btn-sm btn-primary">Download Dokumen</button>
                                                </a>
                                                <a href="{{ route('admin.npk_instansi.edit', ['id' => $draft->id]) }}">
                                                ...
                                                <!-- Modal -->
                                                <form action="{{ route('admin.npk_instansi.destroy', ['id' => $draft->id]) }}"
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ @$edit_mode ? route('admin.npk_instansi.update', ['id' => $detail->id]) : route('admin.npk_instansi.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @if (@$edit_mode)
                                @method('PUT')
                                @endif
                                <div class="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nik" class="form-control @error('nik') is-invalid @enderror" id="nik" placeholder="1234567891234567" value="{{ @$edit_mode ? $detail->nik : old('nik') }}">
                                        @error('nik')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="position" class="form-control @error('position') is-invalid @enderror" id="position" placeholder="Pimpinan / Sekretaris" value="{{ @$edit_mode ? $detail->position : old('position') }}">
                                        @error('position')
